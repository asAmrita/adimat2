...
function [d_out out] = d_laplaceeqn(d_U, U)
   ...
   for it=1 : niter
      ...
      pn = P;
      tmpda14 = x(i)';
      d_tmpca13 = adimat_opdiff_sum(adimat_opdiff_subsref(d_U, struct('type', '()', 'subs', {{i j}})), d_zeros(f(tmpda14, y(j))));
      tmpca13 = U(i, j) + f(tmpda14, y(j));
      d_tmpca12 = adimat_opdiff_mult_right(d_tmpca13, tmpca13, dx ^ 2);
      tmpca12 = tmpca13 * dx^2;
      d_tmpca11 = adimat_opdiff_mult_right(d_tmpca12, tmpca12, dy);
      tmpca11 = tmpca12 * dy;
      d_tmpca10 = adimat_opdiff_mult_right(d_tmpca11, tmpca11, 2);
      tmpca10 = tmpca11 * 2;
      tmpda9 = j - 1;
      tmpda8 = j + 1;
